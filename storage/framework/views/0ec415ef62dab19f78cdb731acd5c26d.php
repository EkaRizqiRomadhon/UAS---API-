...
<body>
    <nav>
        ...
        <div class="nav-right">
            <a href="<?php echo e(url('/')); ?>" style="color: var(--deep-navy); text-decoration: none; font-size: 14px; font-weight: 500;">
...
<?php /**PATH C:\laragon\www\api-UAS-GoTravelJatim--main\resources\views/profile.blade.php ENDPATH**/ ?>