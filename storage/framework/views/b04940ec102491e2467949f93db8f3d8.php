...
<head>
    ...
    <style>
        ...
        .page-hero-bg {
            position: absolute;
            inset: 0;
            background: url('<?php echo e(asset('images/destinations/Gunung Raung.jpg')); ?>') center 40% / cover no-repeat;
        }
        .page-hero-bg::after {
            content: '';
            position: absolute;
...
<body>
        ...
        <ul class="nav-links">
            ...
            <li class="nav-item-dropdown">
                <a href="#" class="dropdown-trigger nav-active">Destinasi <span class="arrow">▾</span></a>
                    ...
                    <li><a href="<?php echo e(url('/trip/2')); ?>"  class="trip-active">Trip 2 Hari</a></li>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            <p class="hero-breadcrumb">
                <a href="<?php echo e(url('/destinations')); ?>">Destinasi</a> &nbsp;/&nbsp; Trip 2 Hari
            </p>
    ...
    <div class="trip-section">
        ...
        <div class="reveal">
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="<?php echo e(asset('images/destinations/Telaga Ngebel.jpg')); ?>" alt="Telaga Ngebel" style="width: 100%; height: 100%; object-fit: cover;">
    ...
    <section class="other-trips">
        <div class="other-trips-inner">
            <p class="other-trips-label">Paket Lainnya</p>
                ...
                <a href="<?php echo e(url('/trip/2')); ?>" class="other-trip-btn current">Trip 2 Hari</a>
...
<?php /**PATH C:\laragon\www\api-UAS-GoTravelJatim--main\resources\views/trip/2.blade.php ENDPATH**/ ?>