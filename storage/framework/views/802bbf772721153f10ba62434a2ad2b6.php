...
<head>
    ...
    <style>
        ...
        .page-hero-bg {
            position: absolute;
            inset: 0;
            background: url('<?php echo e(asset('images/destinations/bukit mongkrang.jpg')); ?>') center 40% / cover no-repeat;
        }
        .page-hero-bg::after {
            content: '';
            position: absolute;
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li class="nav-item-dropdown">
                <a href="<?php echo e(url('/destinations')); ?>" class="dropdown-trigger nav-active">Destinasi <span class="arrow">▾</span></a>
                    ...
                    <li><a href="<?php echo e(url('/trip/4')); ?>"  class="trip-active">Trip 4 Hari</a></li>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            <p class="hero-breadcrumb">
                <a href="<?php echo e(url('/destinations')); ?>">Destinasi</a> &nbsp;/&nbsp; Trip 4 Hari
            </p>
        ...
        <div class="reveal">
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="<?php echo e(asset('images/destinations/trowulan.jpg')); ?>" alt="Situs Majapahit Trowulan" style="width: 100%; height: 100%; object-fit: cover;">
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="<?php echo e(asset('images/destinations/bukit mongkrang.jpg')); ?>" alt="Bukit Mongkrang" style="width: 100%; height: 100%; object-fit: cover;">
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="<?php echo e(asset('images/destinations/Watu karung beach.jpg')); ?>" alt="Pantai Watu Karung" style="width: 100%; height: 100%; object-fit: cover;">
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="<?php echo e(asset('images/destinations/Gunung Raung.jpg')); ?>" alt="Gunung Raung" style="width: 100%; height: 100%; object-fit: cover;">
                    <span class="dest-card-badge">Trekking</span>
                </div>
                <div class="dest-card-body">
    ...
    <section class="other-trips">
        <div class="other-trips-inner">
            <p class="other-trips-label">Paket Lainnya</p>
                ...
                <a href="<?php echo e(url('/trip/1')); ?>" class="other-trip-btn">Trip 1 Hari</a>
                <a href="<?php echo e(url('/trip/2')); ?>" class="other-trip-btn">Trip 2 Hari</a>
                <a href="<?php echo e(url('/trip/3')); ?>" class="other-trip-btn">Trip 3 Hari</a>
                <a href="<?php echo e(url('/trip/4')); ?>" class="other-trip-btn current">Trip 4 Hari</a>
                <a href="<?php echo e(url('/trip/5')); ?>" class="other-trip-btn">Trip 5 Hari</a>
            </div>            </div>
        </div>
    </section>
...
<?php /**PATH C:\laragon\www\api-UAS-GoTravelJatim--main\resources\views/trip/4.blade.php ENDPATH**/ ?>