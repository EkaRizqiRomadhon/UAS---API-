...
<head>
    ...
    <title>Pesan <?php echo e($tour->title); ?> - GoJatim Travel</title>
...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="<?php echo e(url('/destinations')); ?>">Destinasi</a></li>
            <li><a href="<?php echo e(url('/contact')); ?>">Kontak</a></li>
        </ul>
        <div class="nav-right">
            <div class="nav-icons">
                <a href="<?php echo e(url('/profile')); ?>"><i class="far fa-user"></i></a>
            </div>
        </div>
    </nav>
    ...
    <div class="checkout-container">
        <!-- DETAIL PAKET -->
        <div class="tour-info">
            <h2 class="tour-title"><?php echo e($tour->title); ?></h2>
            <div class="tour-meta">
                <p><i class="fas fa-clock" style="width: 20px"></i> <?php echo e($tour->duration_days); ?> Hari</p>
                <p><i class="fas fa-users" style="width: 20px"></i> Maks <?php echo e($tour->max_people); ?> Orang</p>
            </div>
            <p><?php echo e(Str::limit($tour->description, 100)); ?></p>
            
            <div class="tour-price">
                Rp <?php echo e(number_format($tour->price, 0, ',', '.')); ?> <span style="font-size: 14px; color: var(--muted); font-weight: normal">/ orang</span>
            </div>
        </div>
        ...
        <div>
            ...
            <form id="bookingForm">
                ...
                <input type="hidden" id="tour_price" value="<?php echo e($tour->price); ?>">

                <div class="form-group">
                    <label>Tanggal Keberangkatan</label>
                    <input type="date" id="check_in" required min="<?php echo e(date('Y-m-d')); ?>">
                </div>

                <div class="form-group">
                    <label>Jumlah Orang</label>
                    <input type="number" id="jumlah_orang" min="1" max="<?php echo e($tour->max_people); ?>" value="1" required>
                </div>
                ...
                <div class="total-preview">
                    ...
                    <span id="totalDisplay">Rp <?php echo e(number_format($tour->price, 0, ',', '.')); ?></span>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            ...
            const maxCap = parseInt("<?php echo e($tour->max_people); ?>");
...
<?php /**PATH C:\laragon\www\api-UAS-GoTravelJatim--main\resources\views/booking.blade.php ENDPATH**/ ?>