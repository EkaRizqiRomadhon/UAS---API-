...
<head>
    ...
    <style>
        ...
        .page-hero-bg {
            position: absolute;
            inset: 0;
            background: url('<?php echo e(asset('images/destinations/Watu karung beach.jpg')); ?>') center 40% / cover no-repeat;
        }
        .page-hero-bg::after {
            content: '';
            position: absolute;
...
<body>
        ...
        <ul class="nav-links">
            ...
            <li class="nav-item-dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo e(url('/trip/1')); ?>" class="trip-active">Trip 1 Hari</a></li>
    ...
    <section class="page-hero">
        ...
        <div class="page-hero-content">
            <p class="hero-breadcrumb">
                <a href="<?php echo e(url('/destinations')); ?>">Destinasi</a> &nbsp;/&nbsp; Trip 1 Hari
            </p>
    ...
    <div class="trip-section">
        ...
        <div class="dest-cards">
            ...
            <div class="dest-card-item reveal">
                <div class="dest-card-visual">
                    <img src="<?php echo e(asset('images/destinations/Gowa Lowo.webp')); ?>" alt="Goa Lowo" style="width: 100%; height: 100%; object-fit: cover;">
                    <span class="dest-card-badge">Hidden Gem</span>
                </div>
                <div class="dest-card-body">
    ...
    <section class="other-trips">
        <div class="other-trips-inner">
            ...
            <div class="other-trips-list">
                <a href="<?php echo e(url('/trip/1')); ?>" class="other-trip-btn current">Trip 1 Hari</a>
                ...
                <a href="<?php echo e(url('/trip/4')); ?>" class="other-trip-btn">Trip 4 Hari</a>
...
<?php /**PATH C:\laragon\www\api-UAS-GoTravelJatim--main\resources\views/trip/1.blade.php ENDPATH**/ ?>