...
<body>
    <div class="auth-container">
        <a href="<?php echo e(url('/')); ?>" class="auth-logo">Go Jatim <span>Travel</span></a>
        ...
        <div class="auth-footer">
            Belum punya akun? <a href="<?php echo e(url('/register')); ?>">Daftar di sini</a><br><br>
            <a href="<?php echo e(url('/')); ?>" style="color: var(--muted); font-size: 12px;">← Kembali ke Beranda</a>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\api-UAS-GoTravelJatim--main\resources\views/login.blade.php ENDPATH**/ ?>