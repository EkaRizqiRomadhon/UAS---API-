...
<body>
    ...
    <nav>
        ...
        <ul class="nav-links">
            ...
            <li><a href="<?php echo e(url('/tours')); ?>" class="nav-active">Touring</a></li>
    ...
    <section class="weather-section">
        ...
        <div class="weather-grid">
            ...
            <?php $__currentLoopData = $weathers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="weather-card show reveal" style="border-top: 3px solid <?php echo e($w['color']); ?>">
                <p class="weather-card-location">
                    <i class="fas fa-map-marker-alt" style="margin-right:4px"></i><?php echo e($w['location']); ?>

                </p>
                <p class="weather-card-name"><?php echo e($w['name']); ?></p>
                <span class="weather-icon-big"><?php echo e($w['icon']); ?></span>
                <div class="weather-temp"><?php echo e($w['temp']); ?><sup>°C</sup></div>
                <p class="weather-desc"><?php echo e($w['desc']); ?></p>
                <div class="weather-details">
                    <div class="weather-detail-item">
                        <span>Kelembaban</span>
                        <span><?php echo e($w['humidity']); ?></span>
                    </div>
                    <div class="weather-detail-item">
                        <span>Angin</span>
                        <span><?php echo e($w['wind']); ?></span>
                    </div>
                    <div class="weather-detail-item">
                        <span>Terasa</span>
                        <span><?php echo e($w['feels']); ?></span>
                    </div>
                    <div class="weather-detail-item">
                        <span>UV Index</span>
                        <span><?php echo e($w['uv']); ?></span>
                    </div>
                </div>
                <div style="margin-top:16px; padding-top:16px; border-top:1px solid rgba(255,255,255,0.08); font-size:12px; color:var(--accent-gold)">
                    <i class="fas fa-info-circle" style="margin-right:4px"></i><?php echo e($w['status']); ?>
    ...
    <section class="dest-list-section">
        ...
        <table class="dest-table reveal">
            ...
            <tbody>
                ...
                <?php $__currentLoopData = $destList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td>
                        <div class="dest-name"><?php echo e($d['name']); ?></div>
                        <div class="dest-region"><?php echo e($d['spot']); ?></div>
                    </td>
                    <td><?php echo e($d['km']); ?> km</td>
                    <td><span class="time-badge motor"><?php echo e($d['motor']); ?></span></td>
                    <td><span class="time-badge mobil"><?php echo e($d['mobil']); ?></span></td>
                    <td style="font-size:13px; color:var(--muted)"><?php echo e($d['best']); ?></td>
                    <td>
                        <button class="btn-select-dest"
                            onclick="pilihDest('<?php echo e(strtolower($d['name'])); ?>')">
                            Pilih →
                        </button>
                    </td>
                </tr>
...
<?php /**PATH C:\laragon\www\api-UAS-GoTravelJatim--main\resources\views/touring.blade.php ENDPATH**/ ?>